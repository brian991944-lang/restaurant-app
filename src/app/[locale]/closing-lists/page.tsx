    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                    <h1 style={{ fontSize: '2.5rem', marginBottom: '0.5rem', color: 'var(--text-primary)' }}>Opening & Closing Lists</h1>
                    <p style={{ color: 'var(--text-secondary)' }}>Checklists designed for shift handovers and daily wrap-ups.</p>
                </div>
            </div>
